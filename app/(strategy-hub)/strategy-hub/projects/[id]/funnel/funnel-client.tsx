...
export function FunnelClient({ projectId, projectName }: Props) {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <SectionCard
        title="Macierz kanał × etap"
        description="Intensywność aktywności (liczba publikacji / tydz.)."
      >
        <PivotHeatmap channels={channels} activities={activities} />
      </SectionCard>
